...
class SpeedClient(
    ...
    fun hentHistoriskeFødselsnumre(
        ident: String,
        callId: String = UUID.randomUUID().toString(),
    ): Result<HistoriskeIdenterResponse> {
        val jsonInputString = objectMapper.writeValueAsString(IdentRequest(ident))
    ...
    fun hentGeografiskTilknytning(
        ident: String,
        callId: String = UUID.randomUUID().toString(),
    ): Result<GeografiskTilknytningResponse> {
        val jsonInputString = objectMapper.writeValueAsString(IdentRequest(ident))
    ...
    private fun postRequest(
        ...
        callId: String,
    ): Result<HttpResponse<String>> = request("POST", action, jsonInputString, callId)

    private fun deleteRequest(
        action: String,
        jsonInputString: String,
        callId: String,
    ): Result<HttpResponse<String>> = request("DELETE", action, jsonInputString, callId)
...
data class SlettIdenterRequest(
