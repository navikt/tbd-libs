...
class InMemoryAzureTokenCache(
    ...
    override fun bearerToken(scope: String) = fraCacheEllerHentNy(scope) { other.bearerToken(scope) }

    private fun fraCacheEllerHentNy(
        cacheKey: String,
        hentNy: () -> Result<AzureToken>,
