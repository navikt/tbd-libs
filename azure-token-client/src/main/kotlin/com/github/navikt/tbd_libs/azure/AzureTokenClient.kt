...
class AzureTokenClient(
    ...
    private fun requestOnBehalfOfToken(
        scope: String,
        token: String,
    ) = requestToken(buildOnBehalfOfRequestBody(scope, token))
    ...
    private fun buildTokenRequestBody(scope: String): String = buildRequestBody(scope, "client_credentials")

    private fun buildOnBehalfOfRequestBody(
        scope: String,
        token: String,
    ): String =
        buildRequestBody(
    ...
    private fun buildRequestBody(
        ...
        return (standardPayload + additionalPayload + authMethod.requestParameters())
            .entries
