...
internal class RapidIntegrationTest {
    ...
    private fun rapidE2E(testblokk: suspend TestContext.(Job) -> Unit) =
        runBlocking {
    ...
    private suspend fun CoroutineScope.startRapid(
        testTopic: TestTopic,
        extraTestTopic: TestTopic,
        testblokk: suspend TestContext.(Job) -> Unit,
    ) {
    ...
    @Test
    fun `stops while handling messages`() =
        rapidE2E {
    ...
    @Test
    fun `in case of shutdown, the offset committed is the next record to be processed`() =
        rapidE2E {
            ensureRapidIsActive()
    ...
    private fun createTestRapid(
        consumerGroupId: String,
        mainTopic: TestTopic,
        extraTopic: TestTopic,
    ): KafkaRapid {
    ...
    private fun TestContext.testRiver(
        eventName: String,
        serviceId: String,
    ) {
        River(rapid).apply {
    ...
    private fun TestTopic.waitForReply(
        serviceId: String,
        eventName: String,
        event: String?,
    ): RecordMetadata {
